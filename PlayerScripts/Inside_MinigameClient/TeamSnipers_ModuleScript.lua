-- Roblox: Players.SilverAce293026.PlayerScripts.MinigameClient.TeamSnipers
-- Class: ModuleScript
-- Method: bytecode
...
function v1.StateReplication(p3) --[[ Line: 8 ]]
    ...
    u2 = p3;
    l__Common__1.MinigameGui.UpdateTeams(u2.ScoreGoal, 1, 1);
end;
function v1.UpdateScores(p4, p5) --[[ Line: 14 ]]
    -- upvalues: u2 (ref), l__Common__1 (copy)
    if u2 then
        l__Common__1.MinigameGui.UpdateTeams(u2.ScoreGoal, p4, p5);
    end;
end;
return v1;