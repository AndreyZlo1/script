-- Roblox: Workspace.SilverAce293026.HelicopterControl.InputModule
-- Class: ModuleScript
-- Method: bytecode
...
local function u17(u4) --[[ Line: 29 ]]
    ...
    if u2[u4] then
        ...
        local u6 = u2[u4];
        local function u14(_, u7, p8) --[[ Line: 38 ]]
            ...
            if u6 then
                ...
                for _, v10 in u6 do
                    for _, u11 in v10 do
                        local v12, v13 = pcall(function() --[[ Line: 59 ]]
        ...
        if typeof(u4) == "Instance" then
            if u4:IsA("GuiButton") then
                u4.InputBegan:Connect(function(p15) --[[ Line: 72 ]]
                    -- upvalues: u14 (copy)
                    u14(nil, p15.UserInputState, p15);
                end);
                u4.InputEnded:Connect(function(p16) --[[ Line: 76 ]]
                    -- upvalues: u14 (copy)
...
function v1.BindScheme(p18, p19) --[[ Line: 94 ]]
...
function v1.UnbindScheme(p21) --[[ Line: 111 ]]
    -- upvalues: u3 (copy)
    if u3[p21] then
        u3[p21]:Dispose();
        u3[p21] = nil;
...
function v1.GetBoundScheme(p22) --[[ Line: 121 ]]
    -- upvalues: u3 (copy)
    return u3[p22];
end;
function v1.BindToContext(p23, p24, p25) --[[ Line: 125 ]]
...
function v1.UnbindFromContext(p26, p27) --[[ Line: 138 ]]
    -- upvalues: u2 (copy), l__ContextActionService__1 (copy)
    -- block 8
    if not u2[p27] then
        return;
